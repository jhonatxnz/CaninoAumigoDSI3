  ...
  return (
    <div className="content">
            <main className="mainSobre">
              <h1>Sobre o CaninoAumigo</h1>
                <p>O Canino Aumigo é um site produzido por 3 estudantes que tem como foco ajudar os nossos queridos pets! Cães que foram encontrados na rua poderão reencontrar seus donos atravéz do nosso site! Esperamos muito, que nossos aumiguinhos sejam felizes!</p>
                <h1>Doação</h1>
                <p>Se você está pronto para receber um novo membro à sua família, adote um bichinho em nosso site!</p>
                <h1>Adoção</h1>
